...
Home: https://mirrors.openanolis.cn/anolis/23
...
| [![Conda Recipe](https://img.shields.io/badge/recipe-kernel--headers__linux--loongarch64-green.svg)](https://anaconda.org/conda-forge/kernel-headers_linux-loongarch64) | [![Conda Downloads](https://img.shields.io/conda/dn/conda-forge/kernel-headers_linux-loongarch64.svg)](https://anaconda.org/conda-forge/kernel-headers_linux-loongarch64) | [![Conda Version](https://img.shields.io/conda/vn/conda-forge/kernel-headers_linux-loongarch64.svg)](https://anaconda.org/conda-forge/kernel-headers_linux-loongarch64) | [![Conda Platforms](https://img.shields.io/conda/pn/conda-forge/kernel-headers_linux-loongarch64.svg)](https://anaconda.org/conda-forge/kernel-headers_linux-loongarch64) |
...
| [![Conda Recipe](https://img.shields.io/badge/recipe-sysroot__linux--loongarch64-green.svg)](https://anaconda.org/conda-forge/sysroot_linux-loongarch64) | [![Conda Downloads](https://img.shields.io/conda/dn/conda-forge/sysroot_linux-loongarch64.svg)](https://anaconda.org/conda-forge/sysroot_linux-loongarch64) | [![Conda Version](https://img.shields.io/conda/vn/conda-forge/sysroot_linux-loongarch64.svg)](https://anaconda.org/conda-forge/sysroot_linux-loongarch64) | [![Conda Platforms](https://img.shields.io/conda/pn/conda-forge/sysroot_linux-loongarch64.svg)](https://anaconda.org/conda-forge/sysroot_linux-loongarch64) |
...
Once the `conda-forge` channel has been enabled, `kernel-headers_linux-64, kernel-headers_linux-aarch64, kernel-headers_linux-loongarch64, kernel-headers_linux-riscv64, sysroot_linux-64, sysroot_linux-aarch64, sysroot_linux-loongarch64, sysroot_linux-riscv64` can be installed with `conda`:

```
conda install kernel-headers_linux-64 kernel-headers_linux-aarch64 kernel-headers_linux-loongarch64 kernel-headers_linux-riscv64 sysroot_linux-64 sysroot_linux-aarch64 sysroot_linux-loongarch64 sysroot_linux-riscv64
```

or with `mamba`:

```
mamba install kernel-headers_linux-64 kernel-headers_linux-aarch64 kernel-headers_linux-loongarch64 kernel-headers_linux-riscv64 sysroot_linux-64 sysroot_linux-aarch64 sysroot_linux-loongarch64 sysroot_linux-riscv64
```
